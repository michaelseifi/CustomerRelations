...
namespace daisybrand.forecaster.Presentation.Resources.Behaviors
{
    ...
    public class QuantitiesGridBehavior : Behavior<DataPager>
    {
        public static readonly DependencyProperty ActualSourceProperty =
            DependencyProperty.Register("ActualSource", typeof(object), typeof(QuantitiesGridBehavior), null);
        public static readonly DependencyProperty SourcesProperty =
            DependencyProperty.Register("Sources", typeof(IList), typeof(QuantitiesGridBehavior),
            new PropertyMetadata(null, (d, e) => ((QuantitiesGridBehavior)d).OnSourcesChanged((IList)e.NewValue)));
